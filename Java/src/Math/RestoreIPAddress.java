...
//            printArrayList(t);
        ...
        if((t.size()+s.length()-start+1)<=4) {
            System.out.println("start is " + start);
            //System.out.println("char(start) is " + s.charAt(start));
    ...
    public static void main(String[]args){
        ...
        ArrayList<String> temp = (ArrayList<String>) ip.restoreIpAddresses("110110");
        for(String s : temp){
            System.out.println(s);
        }
    }
    
    private void printArrayList(ArrayList<String> temp){
        for(String s : temp){
            System.out.println(s);
        }
        System.out.println();
